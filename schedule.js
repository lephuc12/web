const scheduleData = {
    'X': {
        notice: "📢 Lớp Hàm Số: Lịch học cố định vào Thứ 3 và Thứ 7 hàng tuần, khai giảng vào ngày 30/6/2026. Hãy hoàn thành bài tập về nhà trước giờ lên lớp trực tuyến nhé.",
        resources: [
            { 
                folder: "Giáo trình PDF", 
                files: [
                    { name: "Tính đơn điệu và cực trị của hàm số", link: "https://drive.google.com/..." }
                ] 
            },
            { 
                folder: "Video bài giảng", 
                files: [
                    { name: "Bài giảng: Tính đơn điệu và cực trị của hàm số", link: "https://drive.google.com/..." }
                ] 
            }
        ],
        calendar: [
    ...
    'Y': {
        notice: "📢 Lớp Hình Học không gian: Sắp cập nhật.",
        resources: [
            { 
                folder: "Giáo trình PDF", 
                files: [{ name: "Sắp cập nhật", link: "https://drive.google.com/..." }] 
            }
        ],
        calendar: [
            { id: 1, title: "", time: "", date: "Sắp cập nhật" }
        ]
    },
    'Z': {
        notice: "📢 Lớp Tích Phân: Sắp cập nhật.",
        resources: [
            { 
                folder: "Giáo trình PDF", 
                files: [{ name: "Sắp cập nhật", link: "https://drive.google.com/..." }] 
    ...
    'T': {
        notice: "📢 Lớp Xác Suất: Chuyên đề lý thuyết và bài tập đếm.",
        resources: [
            { 
                folder: "Giáo trình PDF", 
                files: [{ name: "Sắp cập nhật", link: "https://drive.google.com/..." }] 
